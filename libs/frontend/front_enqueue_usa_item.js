// console && console.log("front_enqueue_usa_item_js.js is loaded from usa item")

// This name is defined automatically (InlineShortcodeView_you, for Frontend editor only
window.InlineShortcodeView_usa_item = window.InlineShortcodeView.extend({
  // Render called every time when some of attributes changed.
  render: function () {
    // console && console.log("InlineShortcodeView_usa_item: render called.")
  ...
  updated: function () {
    // console && console.log("InlineShortcodeView_usa_item: updated called.")
    window.InlineShortcodeView_usa_item.__super__.updated.call(this)
    ...
    var $accordion_id = this.$el.parent(".bwl_acc_container"),
    ...
    jQuery($accordion_id)
      .find(".acc_title_bar")
      .attr("class", "")
      // .addClass("acc_title_bar " + accordionData.theme + "-bar " + accordionData.theme + "-title-active " + themNavBox + "")
  ...
  parentChanged: function () {
    ...
    window.InlineShortcodeView_usa_item.__super__.parentChanged.call(this)
  },
