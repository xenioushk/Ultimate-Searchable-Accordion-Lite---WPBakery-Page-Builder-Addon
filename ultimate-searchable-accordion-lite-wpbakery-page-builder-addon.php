...
if ( ! class_exists( 'USA_VC_Addon' ) ) {
    ...
    class USA_VC_Addon {
        ...
        function __construct() {
            ...
            add_action( 'admin_enqueue_scripts', [ $this, 'usa_admin_vc_addon_style' ] );
            ...
            add_filter( 'plugin_row_meta', [ $this, 'usa_vc_metalinks' ], null, 2 );

            /*---  TRANSLATION FILE---*/
            load_plugin_textdomain( 'usa_vc', false, plugin_basename( __DIR__ ) . '/languages/' );
        }
